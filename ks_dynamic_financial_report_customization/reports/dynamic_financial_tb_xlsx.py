...
class KsDynamicFinancialXlsxTB(models.Model):
    ...
    def ks_get_xlsx_trial_balance(self, ks_df_informations):
        ...
        if 'show_hierarchy' in ks_df_informations and ks_df_informations['show_hierarchy']:
        ...
        if ks_df_informations['show_hierarchy']:
            for line in hierarchy_move_lines:  # Normal lines
                row_pos += 1
