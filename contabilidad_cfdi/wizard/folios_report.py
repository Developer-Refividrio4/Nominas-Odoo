...
class FoliosReport(models.TransientModel):
    ...
    fecha_ano = fields.Selection([('2025','2025'),('2024', '2024'),('2023', '2023'),('2022', '2022'),('2021', '2021')],
    ...
    def action_print_folios_report(self):
        ...
        response = requests.post(url,auth=None,data=json.dumps(request_params),headers={"Content-type": "application/json"})
